...
- Repository state: the expected canonical repository is `https://github.com/yewud/depdiff`, but this local Git repository currently has no remote configured and has not been pushed or published to npm.
